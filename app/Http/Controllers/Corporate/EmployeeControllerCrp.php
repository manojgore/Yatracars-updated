...
class EmployeeControllerCrp extends Controller
{
    ...
    public function emp() {
        $customers = Employee::get();
        return view('corporate.employee_view', compact('customers'));
    }

    public function detail($id) {
        $customer_detail = Employee::where('id',$id)->first();
