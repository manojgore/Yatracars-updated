...
use App\Http\Controllers\Corporate\DashboardControllerCrp as DashboardControllerForCrp;
use App\Http\Controllers\Corporate\EmployeeControllerCrp as EmployeeControllerForCrp;
...
/* --------------------------------------- */
Route::get('corporate/dashboard', [DashboardControllerForCrp::class,'crp'])
    ->name('crp_dashboard');
...
/* Employee - Corporate */
/* --------------------------------------- */
Route::get('corporate/employee/view', [EmployeeControllerForCrp::class,'emp'])
    ->name('corporate_employee_view');
