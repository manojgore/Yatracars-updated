<ul>
	...
	<li><a href="{{ route('customer_package_purchase_history') }}" class="btn btn-md btn-block btn-dark">{{ BOOKING_HISTORY }}</a></li>
	<li><a href="{{ route('customer_listing_view') }}" class="btn btn-md btn-block btn-dark">{{ BOOKINGS }}</a></li>
